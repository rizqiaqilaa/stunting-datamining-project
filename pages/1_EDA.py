...
.section-title {
    ...
    border-left: 3px solid #38ef7d; padding-left: 12px; margin: 2rem 0 1rem 0;
}
</style>
...
ax.set_title('Average Annual National Prevalence of Stunting', color='white', fontsize=13, fontweight='bold')
ax.set_xlabel('Tahun', color='#5a8fa8'); ax.set_ylabel('Stunting (%)', color='#5a8fa8')
...
with col1:
    ...
    ax.set_xlabel('Avg Stunting (%)', color='#5a8fa8')
